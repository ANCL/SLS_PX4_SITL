...
void QuasiController(const double x[16], const double Kv2[2], const double Kv6[6],
                     const double M[7], const double point[3], double
                     controller_output[4])
{
  double yr[20];
  double Ts[16];
  ...
  Ts[4] = ((((2.0 * M[0] * (((d_Ts_tmp * t339 * t162 * t220 + ((-t344 *
    ...
    * d_Ts_tmp_tmp_tmp * f_Ts_tmp_tmp_tmp - g_Ts_tmp_tmp_tmp * (t75 *
    c_Ts_tmp_tmp_tmp - t178)) * x[11] * b_Ts_tmp_tmp_tmp) + b_Ts_tmp_tmp * t27 *
  ...
  t75 = (((M[3] - n3) * (x[11] * x[11]) + n3pp / 2.0) * h_Ts_tmp_tmp_tmp *
    ...
    c_Ts_tmp_tmp_tmp;
  t572 = x[11] * x[12] * std::cos(x[6]) * std::sin(x[3]) * (M[3] - n3);
  ...
  t178 = t263 * d_Ts_tmp_tmp_tmp + t572;
  ...
  t221 = ((((2.0 * M[0] * (((t576 + t549 * (b_Ts_tmp_tmp_tmp * b_Ts_tmp_tmp_tmp))
    ...
    (b_Ts_tmp_tmp_tmp * b_Ts_tmp_tmp_tmp)) + l_Ts_tmp) + t15) * t142) + t708 *
           ...
           o_Ts_tmp)) / M[0] / (t274 * t274) / M[2] / t142 / t220;
  ...
  Ts[5] = (((((((((x[11] * (((((((2.0 * M[0] * ((((-3.0 * x[12] * x[11] * t339 *
    ...
    d_Ts_tmp_tmp_tmp + t572) * f_Ts_tmp_tmp_tmp - t99) * b_Ts_tmp_tmp_tmp *
    ...
    + s_Ts_tmp * c_Ts_tmp_tmp * M[2] * M[0] * t27 * b_Ts_tmp_tmp_tmp *
    e_Ts_tmp_tmp_tmp) / M[0] / t274 / M[2] / t142 / t220 - ((((2.0 * M[0] *
    ...
    (b_Ts_tmp_tmp_tmp * b_Ts_tmp_tmp_tmp) + o_Ts_tmp)) / M[0] / (t274 * t274) /
    M[2] / b_Ts_tmp / t220 * (mb_Ts_tmp * i_Ts_tmp_tmp_tmp + t174 *
    ...
    M[0] * h_Ts_tmp_tmp_tmp)) * Ts_tmp_tmp) + t291 * Ts_tmp_tmp_tmp) + t411 *
                      ...
                      d_Ts_tmp_tmp) / M[0] / t274 / M[2] / t142 / t220 - t221 *
                     (-t235 * Ts_tmp_tmp_tmp + Ts_tmp_tmp * t27)) + t285 / t175 /
                    t220 * Ts_tmp_tmp_tmp)) + ((g_Ts_tmp_tmp_tmp *
    d_Ts_tmp_tmp_tmp * x[14] + t65 * x[15]) + t622) / i_Ts_tmp_tmp_tmp *
                  (((((2.0 * M[0] * (((d_Ts_tmp * t706 * t162 * t220 + (-t178 *
    g_Ts_tmp_tmp_tmp - f_Ts_tmp_tmp_tmp * t344 * h_Ts_tmp_tmp_tmp / 2.0) *
    Ts_tmp) + ((std::sin(x[3]) * n3p * std::cos(x[7]) + x[12] * std::sin(x[7]) *
                (M[3] - n3)) * std::sin(x[6]) * g_Ts_tmp_tmp_tmp +
               f_Ts_tmp_tmp_tmp * t250) * x[11] * b_Ts_tmp_tmp_tmp) +
    b_Ts_tmp_tmp * t469 * t162) * M[2] * t175 + t181 * ((((-(std::sin(x[7]) * x
    [11] * std::sin(x[6]) * n3p + ((M[3] - n3) * (x[11] * x[11]) + n3pp / 2.0) *
    i_Ts_tmp_tmp_tmp) * g_Ts_tmp_tmp_tmp - h_Ts_tmp_tmp * x[11] * n3p) * t220 -
    e_Ts_tmp_tmp_tmp * (-(((M[3] - n3) * (x[11] * x[11]) + n3pp / 2.0) *
    h_Ts_tmp_tmp_tmp * d_Ts_tmp_tmp_tmp - x[11] * std::cos(x[6]) * n3p) *
                        g_Ts_tmp_tmp_tmp - f_Ts_tmp_tmp_tmp * t144 *
                        c_Ts_tmp_tmp_tmp) * Ts_tmp) + (-((x[12] * std::sin(x[3])
    * (M[3] - n3) * std::cos(x[7]) - std::sin(x[7]) * n3p) * std::sin(x[6]) -
    1.5 * x[11] * std::cos(x[6]) * (M[3] - n3)) * g_Ts_tmp_tmp_tmp +
    f_Ts_tmp_tmp_tmp * t199) * x[11] * b_Ts_tmp_tmp_tmp) + t120 * t706 * t162) *
                       t142) + t708 * ((((1.3333333333333333 * t675 *
    g_Ts_tmp_tmp_tmp + t558 * f_Ts_tmp_tmp_tmp * x[11] * t162) * x[12] * t220 +
    (-(((((0.66666666666666663 * M[3] - 0.66666666666666663 * n3) * (x[11] * x
    [11]) + (M[3] - n3) * (x[12] * x[12])) + n3pp / 3.0) * c_Ts_tmp_tmp_tmp -
        0.66666666666666663 * x[12] * std::sin(x[7]) * std::sin(x[3]) * n3p) *
       d_Ts_tmp_tmp_tmp - 1.3333333333333333 * x[12] * x[11] * std::cos(x[6]) *
       std::sin(x[3]) * (M[3] - n3)) * g_Ts_tmp_tmp_tmp + f_Ts_tmp_tmp_tmp *
     (0.66666666666666663 * x[12] * std::cos(x[7]) * std::sin(x[3]) * n3p +
      h_Ts_tmp_tmp_tmp * (((0.66666666666666663 * M[3] - 0.66666666666666663 *
    n3) * (x[11] * x[11]) + (M[3] - n3) * (x[12] * x[12])) + n3pp / 3.0))) *
    Ts_tmp) + (-1.3333333333333333 * t172 * d_Ts_tmp_tmp_tmp * g_Ts_tmp_tmp_tmp
               - 1.3333333333333333 * f_Ts_tmp_tmp_tmp * t179) * x[11] *
    b_Ts_tmp_tmp_tmp) - k_Ts_tmp_tmp_tmp * t469 * t162) * b_Ts_tmp) -
                     b_Ts_tmp_tmp_tmp * ((t16 * g_Ts_tmp_tmp_tmp * M[2] *
    Ts_tmp_tmp_tmp * i_Ts_tmp_tmp_tmp * M[0] * t162 * Ts_tmp - e_Ts_tmp * (-t199
    ...
    * g_Ts_tmp_tmp_tmp + f_Ts_tmp_tmp_tmp * t413 * h_Ts_tmp_tmp_tmp)) *
                     Ts_tmp_tmp) + t162 * (t26 * t469 * Ts_tmp - lb_Ts_tmp *
    i_Ts_tmp_tmp_tmp * d_Ts_tmp_tmp * t162)) / M[0] / t274 / M[2] / t142 / t220
                   - t221 * ((-i_Ts_tmp_tmp_tmp * b_Ts_tmp_tmp_tmp *
    g_Ts_tmp_tmp_tmp + (std::sin(x[5]) * std::sin(x[6]) * h_Ts_tmp_tmp_tmp +
                        h_Ts_tmp_tmp) * e_Ts_tmp_tmp_tmp) * Ts_tmp_tmp +
    Ts_tmp_tmp_tmp * t469))) + hb_Ts_tmp * (((((2.0 * M[0] * (((d_Ts_tmp *
    f_Ts_tmp_tmp_tmp * i_Ts_tmp_tmp_tmp * h_Ts_tmp_tmp_tmp * t162 * t220 + (t263
    * i_Ts_tmp_tmp_tmp - d_Ts_tmp * d_Ts_tmp_tmp_tmp * e_Ts_tmp_tmp_tmp * t162) *
    f_Ts_tmp_tmp_tmp * Ts_tmp) - t382 * i_Ts_tmp_tmp_tmp * f_Ts_tmp_tmp_tmp * x
    [11] * b_Ts_tmp_tmp_tmp) + b_Ts_tmp_tmp * f_Ts_tmp_tmp_tmp *
    i_Ts_tmp_tmp_tmp * c_Ts_tmp_tmp_tmp * t162) * M[2] * t175 + t181 *
    ((((g_Ts_tmp_tmp * i_Ts_tmp_tmp_tmp * n3p - t144 * d_Ts_tmp_tmp_tmp) *
       f_Ts_tmp_tmp_tmp * t220 - e_Ts_tmp_tmp_tmp * (t620 * i_Ts_tmp_tmp_tmp +
    k_Ts_tmp_tmp * n3p) * f_Ts_tmp_tmp_tmp * Ts_tmp) + (t42 * i_Ts_tmp_tmp_tmp +
    1.5 * x[11] * d_Ts_tmp_tmp_tmp * t162) * f_Ts_tmp_tmp_tmp * x[11] *
      b_Ts_tmp_tmp_tmp) + t120 * f_Ts_tmp_tmp_tmp * i_Ts_tmp_tmp_tmp *
     h_Ts_tmp_tmp_tmp * t162) * t142) + t708 * (((-1.3333333333333333 * (t11 *
    i_Ts_tmp_tmp_tmp + l_Ts_tmp_tmp / 2.0) * f_Ts_tmp_tmp_tmp * x[12] * t220 +
    (q_Ts_tmp * i_Ts_tmp_tmp_tmp + f_Ts_tmp * d_Ts_tmp_tmp_tmp *
     e_Ts_tmp_tmp_tmp * t162) * f_Ts_tmp_tmp_tmp * Ts_tmp) + p_Ts_tmp *
    ...
    d_Ts_tmp_tmp_tmp * d_Ts_tmp_tmp * t162)) / M[0] / t274 / M[2] / t142 / t220
    - t221 * ((-d_Ts_tmp_tmp_tmp * b_Ts_tmp_tmp_tmp * f_Ts_tmp_tmp_tmp -
              ...
              std::cos(x[6]) * c_Ts_tmp_tmp_tmp))) + gb_Ts_tmp /
                i_Ts_tmp_tmp_tmp * (((((2.0 * M[0] * (((d_Ts_tmp * t27 * t162 *
    ...
    c_Ts_tmp_tmp_tmp - t183)) * x[11] * b_Ts_tmp_tmp_tmp) + b_Ts_tmp_tmp * t174 *
    ...
    b_Ts_tmp_tmp_tmp) + t120 * t27 * t162) * t142) + t708 *
    ...
    * std::cos(x[7]) * std::sin(x[3]) * n3p) * d_Ts_tmp_tmp_tmp *
    f_Ts_tmp_tmp_tmp + g_Ts_tmp_tmp_tmp * q_Ts_tmp) * Ts_tmp) +
      ...
      b_Ts_tmp_tmp_tmp) - k_Ts_tmp_tmp_tmp * t174 * t162) * b_Ts_tmp) -
    ...
    * std::sin(x[7]) * std::sin(x[3]) * (M[3] - n3))) * b_Ts_tmp_tmp_tmp + t162 *
    ...
    t174 * Ts_tmp) / M[0] / t274 / M[2] / t142 / t220 - t221 * ((t125 *
    ...
    ((-c_Ts_tmp_tmp_tmp * x[11] * t162 * d_Ts_tmp_tmp_tmp + m_Ts_tmp_tmp *
     ...
     h_Ts_tmp_tmp_tmp) * Ts_tmp) + t133 * b_Ts_tmp_tmp_tmp) + 2.0 * x[11] * t27 *
    ...
    * Ts_tmp) - 1.5 * i_Ts_tmp_tmp_tmp * t162 * f_Ts_tmp_tmp_tmp * x[11] *
    ...
    h_Ts_tmp_tmp_tmp * t234 * x[11]) * Ts_tmp) + t705 * b_Ts_tmp_tmp_tmp) -
                  1.3333333333333333 * x[11] * t27 * t162) * b_Ts_tmp) -
    ...
    - s_Ts_tmp * x[12] * M[2] * M[0] * t27 * Ts_tmp) / M[0] / t274 / M[2] / t220)
             + n3p * (((((2.0 * M[0] * (((-x[12] * x[11] * t339 * t220 + ((t726 *
    d_Ts_tmp_tmp_tmp / 2.0 - x[11] * x[12] * std::cos(x[6]) * std::sin(x[3])) *
    f_Ts_tmp_tmp_tmp + t699 * h_Ts_tmp_tmp_tmp / 2.0) * Ts_tmp) +
    ...
    * x[11] * M[2] * std::sin(x[4]) * std::sin(x[3]) * M[0] + (M[0] + M[1]) *
    ...
    h_Ts_tmp_tmp_tmp)) * Ts_tmp_tmp) + t203 * M[2] * M[0] * t27 * Ts_tmp) - 2.0 *
                      f_Ts_tmp_tmp_tmp * Ts_tmp_tmp_tmp * i_Ts_tmp_tmp_tmp *
                      d_Ts_tmp_tmp * t162) / M[0] / t274 / M[2] / t142 / t220) +
            n3pp * (((2.0 * M[0] * (-std::sin(x[3]) * c_Ts_tmp_tmp_tmp *
    d_Ts_tmp_tmp_tmp * f_Ts_tmp_tmp_tmp - u_Ts_tmp) * x[11] * b_Ts_tmp_tmp_tmp *
                      M[2] * t175 + t181 * (((std::sin(x[7]) * x[11] * std::sin
    (x[6]) * f_Ts_tmp_tmp_tmp - t223) * t220 + t584 * i_Ts_tmp_tmp_tmp *
    f_Ts_tmp_tmp_tmp * Ts_tmp) + t174 * x[11] * b_Ts_tmp_tmp_tmp) * t142) + t708
                     * ((0.66666666666666663 * i_Ts_tmp_tmp_tmp *
    f_Ts_tmp_tmp_tmp * x[12] * t220 + (-0.66666666666666663 * x[12] * std::sin
    (x[7]) * e_Ts_tmp_tmp_tmp * d_Ts_tmp_tmp_tmp * f_Ts_tmp_tmp_tmp +
    0.66666666666666663 * x[12] * std::cos(x[7]) * std::sin(x[3]) *
    g_Ts_tmp_tmp_tmp) * Ts_tmp) + (0.66666666666666663 * std::sin(x[3]) *
    ...
    * std::sin(x[5]) * std::sin(x[7]) * e_Ts_tmp_tmp_tmp) * x[11] *
                    ...
                    Ts_tmp_tmp_tmp * M[2] * x[12] * t27 * Ts_tmp_tmp) / M[0] /
            t274 / M[2] / t142 / t220) + n3ppp * ((2.0 * M[0] * (-std::cos(x[5])
              * std::sin(x[6]) * std::cos(x[7]) / 2.0 - a_tmp_tmp_tmp_tmp_tmp /
              2.0) * Ts_tmp * M[2] * t175 + t181 * (i_Ts_tmp_tmp * t220 / 2.0 -
              e_Ts_tmp_tmp_tmp * (t395 / 2.0 - a_tmp_tmp_tmp / 2.0) * Ts_tmp) *
             t142) + t708 * (t262 / 3.0 + a_tmp_tmp_tmp_tmp_tmp / 3.0) * Ts_tmp *
            b_Ts_tmp) / M[0] / t274 / M[2] / t142 / t220) + (((((-4.0 * x[11] *
    ...
    * (((-4.0 * x[11] * d_Ts_tmp_tmp_tmp * t162 * n_Ts_tmp + x[12] * std::cos(x
    ...
    f_Ts_tmp_tmp_tmp * x[11] * i_Ts_tmp_tmp_tmp * e_Ts_tmp_tmp_tmp * t27 * t162)
    * t142) - 8.0 * (((x[12] * f_Ts_tmp_tmp_tmp * i_Ts_tmp_tmp_tmp * t27 * t162 *
    ...
    * Ts_tmp_tmp) + 4.0 * x[12] * std::cos(x[5]) * Ts_tmp_tmp_tmp *
    b_Ts_tmp_tmp_tmp * i_Ts_tmp_tmp_tmp * t27 * t162) / M[0] / M[2] / t721 /
  ...
  t572 = (-std::cos(x[7]) * std::sin(x[3]) * std::sin(x[6]) * n3pp / 2.0 + x[11]
  ...
  Ts[11] = (((((((((x[11] * (((((((((4.0 * t142 * M[2] * M[0] * n3pp * t339 *
    ...
    * t162 * M[2] * Ts_tmp_tmp) * b_Ts_tmp_tmp_tmp) - t413 * e_Ts_tmp_tmp_tmp) +
    g_Ts_tmp * (-2.0 * b_Ts_tmp_tmp * M[2] * Ts_tmp_tmp_tmp * b_Ts_tmp_tmp_tmp *
                M[0] * t27 * b_Ts_tmp + i_Ts_tmp_tmp * b_Ts_tmp_tmp_tmp *
    ...
    t144 * Ts_tmp_tmp * Ts_tmp_tmp_tmp + 2.0 * b_Ts_tmp * t572) - 2.0 *
    cb_Ts_tmp * t572) * Ts_tmp) + (((6.0 * M[0] * M[2] * t443 * x[11] * b_Ts_tmp
    * Ts_tmp_tmp_tmp - 2.0 * M[0] * t142 * M[2] * t671 * x[11]) + 4.0 * M[0] *
    ...
    e_Ts_tmp_tmp_tmp * M[0] * t27) + 4.0 * b_Ts_tmp_tmp * M[2] * cb_Ts_tmp *
    e_Ts_tmp_tmp_tmp * M[0] * t27 * Ts_tmp_tmp)) / M[0] / t252 / M[2] / b_Ts_tmp
    / t220 - t551 * ((-Ts_tmp_tmp_tmp * b_Ts_tmp_tmp_tmp * f_Ts_tmp_tmp_tmp *
                      i_Ts_tmp_tmp_tmp + t610 * Ts_tmp_tmp_tmp) + std::cos(x[4])
                     * (std::cos(x[5]) * std::sin(x[6]) * std::cos(x[7]) + std::
                        sin(x[5]) * std::sin(x[7])))) + 2.0 * t620 / M[0] / t252
    / M[2] / t142 / t220 * Ts_tmp_tmp_tmp)) + ((std::sin(x[5]) * std::sin(x[6]) *
    x[14] + std::cos(x[5]) * std::sin(x[6]) * x[15]) + x[13] * std::cos(x[6])) /
                   std::cos(x[6]) * (((((t15 * t706 * t721 + M[2] * std::sin(x[3])
    * rt_powd_snf(std::cos(x[4]), 3.0) * rt_powd_snf(std::cos(x[3]), 3.0) *
    g_Ts_tmp_tmp_tmp * i_Ts_tmp_tmp_tmp * M[0] * n3pp) + t523 * (((-t219 *
    g_Ts_tmp_tmp_tmp - 3.0 * f_Ts_tmp_tmp_tmp * c_Ts_tmp_tmp_tmp * t75) *
    b_Ts_tmp + 2.0 * std::sin(x[4]) * (-(-std::cos(x[7]) * std::sin(x[3]) * std::
    sin(x[6]) * n3pp / 2.0 + x[11] * x[12] * std::cos(x[6]) * (M[3] - n3)) *
    g_Ts_tmp_tmp_tmp - o_Ts_tmp_tmp_tmp * e_Ts_tmp_tmp_tmp * n3pp / 2.0) *
    Ts_tmp_tmp) + c_Ts_tmp_tmp * t706 * t162) * Ts_tmp) + (((t260 * (-((x[12] *
    (M[3] - n3) * std::cos(x[7]) - std::sin(x[7]) * std::sin(x[3]) * n3p) * std::
    sin(x[6]) - 1.5 * x[11] * std::cos(x[6]) * std::sin(x[3]) * (M[3] - n3)) *
    ...
    / t252 / M[2] / b_Ts_tmp / t220 - t551 * ((r_Ts_tmp * g_Ts_tmp_tmp_tmp *
    i_Ts_tmp_tmp_tmp - e_Ts_tmp_tmp_tmp * t706 * Ts_tmp_tmp) + std::sin(x[4]) *
    (-std::sin(x[5]) * std::sin(x[6]) * std::cos(x[7]) + std::cos(x[5]) * std::
     sin(x[7]))))) + (std::cos(x[5]) * x[14] - std::sin(x[5]) * x[15]) *
                  (((((t15 * f_Ts_tmp_tmp_tmp * i_Ts_tmp_tmp_tmp *
                       h_Ts_tmp_tmp_tmp * t721 + M[2] * std::sin(x[3]) *
                       rt_powd_snf(std::cos(x[4]), 3.0) * rt_powd_snf(std::cos
    (x[3]), 3.0) * f_Ts_tmp_tmp_tmp * d_Ts_tmp_tmp_tmp * M[0] * n3pp) + t523 *
                      (((t183 * i_Ts_tmp_tmp_tmp + 2.0 * x[11] * std::sin(x[6]) *
    n3p) * f_Ts_tmp_tmp_tmp * b_Ts_tmp + 2.0 * std::sin(x[4]) * (-std::cos(x[7])
    * std::sin(x[3]) * i_Ts_tmp_tmp_tmp * n3pp / 2.0 - x[11] * x[12] * std::sin
    (x[6]) * t162) * f_Ts_tmp_tmp_tmp * Ts_tmp_tmp) + c_Ts_tmp_tmp *
                       f_Ts_tmp_tmp_tmp * i_Ts_tmp_tmp_tmp * h_Ts_tmp_tmp_tmp *
                       t162) * Ts_tmp) + (((t260 * (t250 * i_Ts_tmp_tmp_tmp +
    ...
    i_Ts_tmp_tmp_tmp * c_Ts_tmp_tmp_tmp * b_Ts_tmp) - t65 * e_Ts_tmp_tmp_tmp *
    ...
    [7])))) + k_Ts_tmp * ((((t15 * t27 * t721 + t523 * (((t121 *
    ...
    * h_Ts_tmp_tmp_tmp * t75) * b_Ts_tmp + 2.0 * std::sin(x[4]) * (t629 *
    ...
    e_Ts_tmp_tmp_tmp * n3pp / 2.0) * Ts_tmp_tmp) + c_Ts_tmp_tmp * t27 * t162) *
    ...
    q_Ts_tmp_tmp_tmp * c_Ts_tmp_tmp_tmp * x[11]) * t162 * M[2] * x[12] *
                Ts_tmp_tmp) - t178 * t27) * b_Ts_tmp_tmp_tmp) + g_Ts_tmp * (t55 *
    t27 * t142 - t234 * t174 * b_Ts_tmp)) / M[0] / t252 / M[2] / b_Ts_tmp / t220
    - t551 * (-std::sin(x[3]) * t27 * Ts_tmp_tmp + std::sin(x[4]) * (-std::cos
    (x[5]) * std::sin(x[6]) * std::sin(x[7]) + std::sin(x[5]) * std::cos(x[7])))))
    ...
    t142 - t708 * Ts_tmp_tmp_tmp * e_Ts_tmp_tmp_tmp * M[0] * t27 * b_Ts_tmp)) /
    ...
    * ((-x[12] * std::cos(x[7]) * d_Ts_tmp_tmp_tmp + 1.5 * x[11] * std::cos(x[6])
    ...
    t181 * t27 * x[11] * b_Ts_tmp) * b_Ts_tmp_tmp_tmp) / M[0] / t252 / M[2] /
    ...
    * t89 * t162 * t142 / 4.0 + (((((x[11] * (n_Ts_tmp_tmp - 2.0) * t162 *
    ...
    Ts_tmp_tmp_tmp * i_Ts_tmp_tmp_tmp * t27 * t162 * t142) + ((((-2.0 *
    ...
    * b_Ts_tmp) + 4.0 * ((((m_Ts_tmp_tmp_tmp * (n_Ts_tmp_tmp - 2.0) * t162 *
    ...
    e_Ts_tmp_tmp_tmp * t27 * t162) * b_Ts_tmp_tmp_tmp) - 4.0 * (-std::sin(x[3]) *
  ...
  t156 = (t125 + h_Ts_tmp * (-t155 + 1.5)) * n_Ts_tmp;
  t157 = t72_tmp * x[11];
  ...
  t50 = (b_Ts_tmp_tmp_tmp * (((b_Ts_tmp_tmp_tmp * ((b_Ts_tmp_tmp_tmp *
    ...
    ((1.3333333333333333 * t124 * (0.25 - n_Ts_tmp_tmp) + 1.3333333333333333 *
      h_Ts_tmp * (0.375 - t118)) - n_Ts_tmp * (t126 + t125) *
     0.33333333333333331) - t128 * (n_Ts_tmp_tmp + -2.0)) + g_Ts_tmp_tmp_tmp * (
    -0.5 * (t72_tmp * (0.5 * (t129 + t47_tmp) - t130) - t132) - t80 * (t72_tmp *
    0.25 * x[11] * (n_Ts_tmp_tmp + -1.3333333333333333) + t133)) * 4.0) + 2.0 *
  ...
  t206 = t622 * g_Ts_tmp_tmp_tmp + t205;
  t207 = t88 * t206;
  ...
  t226 = ((-0.5 * g_Ts_tmp * (t206 * x[12] + x[11] * (-g_Ts_tmp_tmp_tmp * (t226
    ...
    * ((3.0 * t124 * (17.5 - n_Ts_tmp_tmp) + 3.0 * h_Ts_tmp * (t118 + 4.0)) -
       52.5 * n_Ts_tmp * (t125 + h_Ts_tmp * (-0.22857142857142856 * n_Ts_tmp_tmp
  ...
  t125 = ((t231 * 0.5 + n_Ts_tmp * (-t231 + 10.5 * a_tmp_tmp_tmp_tmp_tmp * x[11]
            * e_Ts_tmp_tmp_tmp * n3p)) + f_Ts_tmp_tmp_tmp * ((((f_Ts_tmp_tmp_tmp
              * (((f_Ts_tmp_tmp_tmp * (x[12] * ((h_Ts_tmp *
    (-0.18181818181818182 * n_Ts_tmp_tmp + 0.36363636363636365) + t124 *
    (-2.5454545454545454 - n_Ts_tmp_tmp)) * 16.5 + t263 * (t257 + t125)) +
    t72_tmp * ((-12.0 * db_Ts_tmp * t259 * (2.0 - n_Ts_tmp_tmp) + 12.0 *
                k_Ts_tmp_tmp * (t260 + 2.625) * n3p) + 10.5 * t208)) +
                   g_Ts_tmp_tmp_tmp * ((t218 * (t81 + 10.5) + 126.0 * t47_tmp *
    x[12] * (n_Ts_tmp_tmp + -1.3333333333333333) * t13) - 12.0 * t43_tmp * t259 *
    d_Ts_tmp_tmp_tmp)) + c_Ts_tmp_tmp_tmp * ((c_Ts_tmp_tmp_tmp * ((l_Ts_tmp *
    t259 * 24.0 + t175 * (n_Ts_tmp_tmp * 31.5 - 42.0)) * e_Ts_tmp_tmp_tmp *
    g_Ts_tmp_tmp_tmp + t212) + i_Ts_tmp_tmp_tmp * (-12.0 * t25 * x[12] *
    g_Ts_tmp_tmp_tmp * n3p - t213 * 0.5)) + t47_tmp * (-67.5 * n_Ts_tmp_tmp +
    126.0) * x[12] * g_Ts_tmp_tmp_tmp)) - t211) + n_Ts_tmp * (t229 * 31.5 +
    (-126.0 * t124 + 126.0 * t265) * x[12])) + c_Ts_tmp_tmp_tmp * ((-db_Ts_tmp *
    ((-12.0 * t259 * e_Ts_tmp_tmp_tmp - t219) + t221) + t222) - 25.5 *
              k_Ts_tmp_tmp * e_Ts_tmp_tmp_tmp * n3p)) + i_Ts_tmp_tmp_tmp *
            (-t201 * t190 * e_Ts_tmp_tmp_tmp - t266)) + t88 * (m_Ts_tmp * 36.0 -
            t227))) + eb_Ts_tmp * (-4.5 * l_Ts_tmp_tmp_tmp * e_Ts_tmp_tmp_tmp +
    t70 * (t263 - 36.0));
  ...
  t204 = i_Ts_tmp_tmp_tmp * (t205 * g_Ts_tmp_tmp_tmp + t622);
  t205 = t204 - t246;
  ...
  t135 += b_Ts_tmp_tmp_tmp * (-t321 + ((f_Ts_tmp_tmp_tmp * ((f_Ts_tmp_tmp_tmp *
    ...
    * ((t317 * t286 + 2.0 * t314 * ((-t247 * 30.0 + t310) + t311)) - t293 * 18.0))
    ...
    48.0 - g_Ts_tmp * (t125 + t250)) + t251) + t307) + 54.0 * t290) - t308))) *
    f_Ts_tmp_tmp_tmp);
  ...
  t378 = 54.0 * t243;
  t379 = t65 * k_Ts_tmp_tmp * e_Ts_tmp_tmp_tmp;
  t380 = 12.0 * x[12];
  ...
  t76 = e_Ts_tmp * ((t44 * 36.0 * f_Ts_tmp_tmp_tmp * b_Ts_tmp_tmp * t273 + 54.0 *
    ...
    (72.0 * t124 + t287) + t65)) - 54.0 * t286) + t292 * (1.0 - t318) * (54.0 *
  ...
  t38 = t41 * (-4.0 * ((t92 * Ts_tmp + b_Ts_tmp_tmp_tmp * (6.0 * t115 * ((3.0 *
    ...
    - t46 * 0.16666666666666666) * ab_Ts_tmp) * 18.0)) + t125 * t44 *
  ...
  t35 = 4.5 - t35;
  t169 *= t54;
  t274 = k_Ts_tmp_tmp * i_Ts_tmp_tmp_tmp;
  t67 *= n_Ts_tmp;
  ...
  t82 = (f_Ts_tmp_tmp_tmp * ((f_Ts_tmp_tmp_tmp * ((f_Ts_tmp_tmp_tmp * (((-4.0 *
    ...
    * (t288 + -0.5625) * n3p) * 10.666666666666666 + 2.0 * t208) +
    ...
    (n_Ts_tmp_tmp + -0.5) + 2.6666666666666665 * t274) + n_Ts_tmp * ((-t279 +
  ...
  t65 = ((t153 * Ts_tmp_tmp - t148 * a_tmp_tmp_tmp_tmp_tmp * t66) + e_Ts_tmp *
         (eb_Ts_tmp * (12.0 * t272 - 6.0 * t93) - 2.0 * c_Ts_tmp_tmp_tmp *
          (-t130 - t65))) + ((f_Ts_tmp_tmp_tmp * ((f_Ts_tmp_tmp_tmp *
    (c_Ts_tmp_tmp_tmp * (((-t213 * 18.0 * t66 + 36.0 * i_Ts_tmp_tmp_tmp * (-t367
    * t103 + t108)) - t108 * 18.0 * t11) - 54.0 * t292 * t66) + e_Ts_tmp *
     ((-6.0 * i_Ts_tmp_tmp_tmp * (-t234 - 6.0 * t91) + 6.0 * t290) + n_Ts_tmp *
      (t111 + i_Ts_tmp_tmp_tmp * (n_Ts_tmp_tmp * t91 - 2.0 * t91)) * 36.0) *
    ...
    c_Ts_tmp_tmp_tmp * ((-54.0 * t80 * t66 * d_Ts_tmp_tmp_tmp - t610 * t397) -
                        t292 * 36.0 * (0.66666666666666663 * t60 - t223))) - 2.0
  ...
  t65 = ((Ts_tmp_tmp * t65 + g_Ts_tmp_tmp_tmp * (-t212_tmp * ((n_Ts_tmp * t142 -
    ...
    -1.3333333333333333) * t142 - t142 * g_Ts_tmp) + i_Ts_tmp_tmp_tmp * (-t392 *
              t25 * 0.44444444444444442 + 0.14814814814814814 * t378_tmp * t357)))))
         + f_Ts_tmp_tmp_tmp * (((ab_Ts_tmp * ((n_Ts_tmp * (t395 * (t237 - 12.0) *
    n3p + t145 * (t301 - 36.0)) + e_Ts_tmp * (-12.0 * t364 * (n_Ts_tmp_tmp +
    -2.0) * Ts_tmp_tmp_tmp * c_Ts_tmp_tmp + 6.0 * t69 * Ts_tmp_tmp_tmp)) + t81 *
             (-14.0 * t284_tmp * n_Ts_tmp_tmp + t142 * 9.0)) + c_Ts_tmp_tmp_tmp *
            (c_Ts_tmp_tmp_tmp * (t69 * t325 + 27.0 * t145) - 12.0 * t327 *
             p_Ts_tmp * c_Ts_tmp_tmp)) - 6.0 * t81 * (t138 - t284_tmp)) - 6.0 *
          t395 * n3p)) * Ts_tmp_tmp;
  t65 = (48.0 * t175 * (Ts_tmp_tmp_tmp * ((-((3.0 * g_Ts_tmp * (0.75 * t205 *
    (n_Ts_tmp_tmp + -1.3333333333333333) + t274 * 0.58333333333333337) - 3.0 *
              n_Ts_tmp * (t279 - t97)) + 3.0 * l_Ts_tmp_tmp_tmp * (t260 +
    ...
    (t89 / 15.0 - t169) - 1.75 * t90) * c_Ts_tmp_tmp_tmp) + c_Ts_tmp_tmp_tmp *
             ...
             (n_Ts_tmp_tmp + -1.3333333333333333) * (0.25 - n_Ts_tmp) + 3.0 *
             t72_tmp * (t20 * t119 + 1.1666666666666667 * t165)) *
            g_Ts_tmp_tmp_tmp * ab_Ts_tmp + g_Ts_tmp_tmp_tmp * (t72_tmp * n3p *
             t100 + t272 * (0.25 - n_Ts_tmp))) + f_Ts_tmp_tmp_tmp * ((ab_Ts_tmp *
  ...
  t65 += b_Ts_tmp_tmp_tmp * ((72.0 * t175 * (-Ts_tmp_tmp_tmp * (g_Ts_tmp_tmp_tmp
    * (0.66666666666666663 * t88 * n_Ts_tmp * e_Ts_tmp_tmp_tmp - 2.0 * ab_Ts_tmp
    ...
    t15);
  t65 = (((((b_Ts_tmp_tmp_tmp * t65 + 48.0 * t41 * b_Ts_tmp_tmp * g_Ts_tmp *
             (-t102 * Ts_tmp_tmp + t120 * t106)) + b_Ts_tmp * ((Ts_tmp_tmp *
              (f_Ts_tmp_tmp_tmp * ((f_Ts_tmp_tmp_tmp * (-o_Ts_tmp * (-t335 *
    t362 + t76 * ((-0.66666666666666663 * l_Ts_tmp_tmp + 1.8333333333333333 *
                   t62) + t181 * n_Ts_tmp) * e_Ts_tmp_tmp_tmp) * 36.0 +
    i_Ts_tmp_tmp * (-t75 * t362 * g_Ts_tmp + 3.6666666666666665 * t21 *
                    (l_Ts_tmp_tmp_tmp * (-0.36363636363636365 * n_Ts_tmp_tmp +
    ...
    c_Ts_tmp_tmp_tmp) * (c_Ts_tmp_tmp_tmp + 1.0) + ab_Ts_tmp * (-0.5 * g_Ts_tmp *
    (t336 * e_Ts_tmp * b_Ts_tmp_tmp - l_Ts_tmp * t35) + c_Ts_tmp_tmp_tmp *
    (e_Ts_tmp * (i_Ts_tmp_tmp_tmp * (-t378_tmp * (-t328 + c_Ts_tmp_tmp) - t276)
                 - t243 * g_Ts_tmp) * 0.16666666666666666 - t350 * t35)) * 36.0))
             + f_Ts_tmp_tmp_tmp * ((ab_Ts_tmp * (-6.0 * e_Ts_tmp * ((t278 *
    (n_Ts_tmp_tmp * t32 + t16 * 4.0) - 2.0 * t323) - t81 * (t192 + b_Ts_tmp_tmp))
    - t365 * (n_Ts_tmp_tmp + -2.0) * t35) - 18.0 * c_Ts_tmp_tmp_tmp * (t327 *
    t35 + t349 * (-t124 - t13))) + t153 * x[11] * t32))) + 7.0 * i_Ts_tmp_tmp *
           t259 * d_Ts_tmp_tmp * t386_tmp) + t42) - t11) * b_Ts_tmp_tmp_tmp;
  ...
  Ts[1] = -(((Ts_tmp_tmp * t275 * (-9.0 * ((b_Ts_tmp * t82 - 0.22222222222222221
    ...
    * f_Ts_tmp_tmp_tmp * (n_Ts_tmp * t226 + ab_Ts_tmp * (((n_Ts_tmp * t196 -
    ...
    t271 * Ts_tmp_tmp + t259) - t376 * (t120 * t391 + t44)) + t53_tmp *
               2.5714285714285716 * t390 * e_Ts_tmp_tmp_tmp * b_Ts_tmp)) + t65) *
  ...
  t168 = -4.0 * g_Ts_tmp * (t262 * t58 + x[11] * t165) - 2.0 * t160 * t167;
  ...
  t29 = (t187 * (-t184_tmp * t216 + t205 * (-t202 + t200)) + t156_tmp * ((((M[0]
    ...
    * ((b_Ts_tmp_tmp_tmp * (t96 - t61) * t74 + t97 * (-2.0 * bb_Ts_tmp + 7.0 *
    ...
    (t126 - t137))) + ((-t118 * e_Ts_tmp_tmp_tmp * 2.0 + b_Ts_tmp_tmp_tmp *
                        ((t112 * m_Ts_tmp_tmp_tmp * f_Ts_tmp_tmp_tmp - t65 *
  ...
  t264 = t622 + gb_Ts_tmp * d_Ts_tmp_tmp_tmp;
  ...
  t312 = 4.0 * g_Ts_tmp * (t262 * g_Ts_tmp_tmp_tmp * t725 + x[11] * t161 * t270);
  t313 = -t270;
  t314 = t194 * 4.0;
  t315 = t314 * g_Ts_tmp;
  ...
  t448 = (e_Ts_tmp * t443 * 3.0 * Ts_tmp_tmp - b_Ts_tmp_tmp_tmp * t436) *
    Ts_tmp_tmp;
  t234 = t135_tmp * (-t125 * Ts_tmp_tmp + t444) - t446_tmp * Ts_tmp;
  ...
  t199 = f_Ts_tmp_tmp_tmp * t174 + t458 * g_Ts_tmp;
  ...
  t293 = t254 * x[12];
  t297 = t293 * x[11];
  t142 = t182 * (t135 * e_Ts_tmp_tmp_tmp + t262);
  ...
  t708 = t572 * t253_tmp;
  t308 = gb_Ts_tmp * ((3.0 * t518 * t454 + t509 * (((t187 * ((t235 + t253_tmp *
    t449) + t37) - t436) - t125) + t443)) - t56 * t253_tmp) + t264 * ((3.0 *
  ...
  t713 = -t27 * (n_Ts_tmp_tmp - 2.0) * f_Ts_tmp_tmp_tmp + t712;
  ...
  p_Ts_tmp_tmp_tmp = Ts_tmp_tmp * (b_Ts_tmp_tmp_tmp * (b_Ts_tmp_tmp_tmp *
    ((-g_Ts_tmp_tmp_tmp * t505 + t174 * b_Ts_tmp_tmp) + kb_Ts_tmp * t284) - t121)
    - b_Ts_tmp_tmp * -t270);
  ...
  t18 = ((((-2.0 * (t509 * ((n3pp * t121 + t288 * t452_tmp) - t297 * (2.0 * t198
    * t413 + t620))) + x[11] * (-t137 * (t147_tmp * ((t156_tmp * (((-t202 *
    ...
    ((-t24 * t253_tmp + t235) + t37) - t125) - t436) + t443) + t254 * t68))) +
  ...
  u_Ts_tmp = g_Ts_tmp_tmp_tmp * t60 - t174 * e_Ts_tmp_tmp_tmp * n3pp;
  t80 = t462 - t87;
  ...
  t18 = ((((((((((n3p * (((((-2.0 * t509 * (n3p * (-i_Ts_tmp_tmp *
    ...
    - t220 * ((-Ts_tmp_tmp * t27 + t346) + t154 * t399)) - t6_tmp * t21) - t74)
              ...
              hb_Ts_tmp * t22) + x[13] * t182) + t6_tmp * t18) - (0.0 - t610)) -
  ...
  t572 = b_Ts_tmp_tmp_tmp * (t427 * (t250 * 6.0 * Ts_tmp_tmp + t491) + t314 *
    t670 * x[11]);
  t434 *= Ts_tmp_tmp_tmp;
  t366 = ((-3.0 * t499 * t402 + t623 * i_Ts_tmp_tmp * (-t174 * 6.0 *
  ...
  t68 = (t227 * (-t354 * t245 * t416 * t662 + t245 * (t416 * (t558_tmp * t662 -
    ...
    + t211) + t330) - t572 * n3pp) - n3ppp * t636) + t237 * cb_Ts_tmp) + t208 *
  ...
  t12 = (((x[11] * (t281 * (t12 * t184 + t126) - t294 * 3.0 * t436) + x[12] *
           (t281 * (t636 + t507 * t436) - t176 * 2.0 * t436)) - t125 * (t12 *
  ...
  controller_output[1] = ((((((((((n3p * (((((-2.0 * t281 * (-n3p * d_Ts_tmp_tmp
    * t339 - t297 * t45) + t235 * (((((-3.0 * t81 * t147_tmp * e_Ts_tmp_tmp_tmp
    ...
    t388) * t141_tmp * t125_tmp) + n3pp * ((((-2.0 * (t125 * t199 + t6_tmp *
    (gb_Ts_tmp * t293 * t226 * t27 - t174 * t620)) + t235 * (t430 *
    (-e_Ts_tmp_tmp_tmp * t147_tmp * 6.0 + t24) + t316)) + t274 * (t430 * (-t254 *
    4.0 + 2.0 * t507) + t572)) + t281 * (t340 - t331 * (b_Ts_tmp_tmp_tmp *
    ...
    t281 * (t443 * t184 + t297 * (((-t184 * t233 * t270 - t65) + t171) - t661 *
    ...
    * t339 * t661 + t174_tmp * (-x[11] * t233 - t222)) * t141_tmp * t125_tmp *
    Ts_tmp_tmp_tmp) + t235 * (((3.0 * t54 * t147_tmp * e_Ts_tmp_tmp_tmp +
    w_Ts_tmp) + t157) + t71 * t184)) + t274 * ((t254 * 2.0 * t54 + t507 * -t54)
    + t418)) + t125 * (-t71 * t467 + t47)) + t6_tmp * (t262 * (2.0 * t46 - t71 *
    t452_tmp) + t174 * (b_Ts_tmp_tmp_tmp * t623 + t71 * t251))) + t281 * (((n3p *
    ...
    * t574 - t375 * t201 * f_Ts_tmp_tmp_tmp)) - t319 * t577) - 4.0 * Ts_tmp_tmp *
    ...
    t10) - (0.0 - t382)) + t28 * t163) - t281 * n3pppp * t436) + t29 *
    ((((((-2.0 * t66 * (t416 * x[11] * t187 + ((n3pp * t60 * t174_tmp + t148 * (
              -t44 * x[11] + t54)) - t139 * (x[11] * (6.0 * t198 *
              b_Ts_tmp_tmp_tmp * (b_Ts_tmp_tmp_tmp * t472_tmp - t42) - t437 *
              t180 * x_Ts_tmp) + t233) * t225) * t141_tmp * t125_tmp) + t235 *
          ((((-3.0 * t153 * t147_tmp * e_Ts_tmp_tmp_tmp - t65) + t171) - t661 *
            (t34 * 2.0 * e_Ts_tmp_tmp_tmp + t206)) + t40 * t184)) - t274 *
         (((t254 * 2.0 * t153 + b_Ts_tmp_tmp_tmp * (-t164 + t387_tmp * (t34 *
              Ts_tmp_tmp_tmp - Ts_tmp_tmp * (-t551 * 2.0 * Ts_tmp_tmp *
    Ts_tmp_tmp_tmp + 2.0 * t92)))) - t230) - t507 * t153)) + t125 * ((t477 + t93)
         - t40 * t467)) + t6_tmp * (t262 * (-t40 * t452_tmp + t36) + t174 *
        ((b_Ts_tmp_tmp_tmp * ((-2.0 * f_Ts_tmp * (Ts_tmp_tmp * t711 + t295) +
            t301) + t413) - t154) + t40 * t251))) + t281 * (((n3p * t45 - t285 *
         t184) + t239) - t331 * (((b_Ts_tmp_tmp_tmp * ((-4.0 * t173 * t135_tmp *
            t344 + Ts_tmp_tmp * (t130 * 8.0 * Ts_tmp_tmp - t170 * Ts_tmp_tmp_tmp
             * 2.0)) + a_tmp_tmp * Ts_tmp_tmp * (-8.0 * (f_Ts_tmp_tmp_tmp *
             (f_Ts_tmp_tmp_tmp * (((g_Ts_tmp * n_Ts_tmp_tmp - t580 * g_Ts_tmp /
    2.0) + M[3] / 2.0) - n3 / 2.0) + t212_tmp * t265) - t634 * g_Ts_tmp) + t319 *
            t585 * b_Ts_tmp)) - g_Ts_tmp * 4.0 * t135_tmp * t409) + Ts_tmp_tmp *
         (Ts_tmp_tmp_tmp * (4.0 * f_Ts_tmp_tmp_tmp * (h_Ts_tmp_tmp * t197 *
            e_Ts_tmp_tmp_tmp + t165 * g_Ts_tmp_tmp_tmp) - t319 * j_Ts_tmp_tmp *
           e_Ts_tmp_tmp_tmp) + t475_tmp * (t592 * ab_Ts_tmp - 2.0))) *
  ...
  controller_output[3] = (-i_Ts_tmp_tmp_tmp * (M[5] * x[13] * x[14] * t162 *
    ...
    * x[15]) * f_Ts_tmp_tmp_tmp + t23) - t23 * 2.0 * ab_Ts_tmp)) * (t6_tmp *
    t6_tmp) * t160_tmp * t103 - (0.0 - (Kv2[0] * -(0.0 - x[7]) + Kv2[1] * -(0.0
    - k_Ts_tmp)));
